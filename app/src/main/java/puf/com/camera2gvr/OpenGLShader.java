...
public class OpenGLShader {
	private static final String TAG = "OpenGLShader";
	private static int compileShader(int shaderType, String source) {
		...
		RenderUtils.checkNoGLES2Error("compileShader");
		return shader;
	}
	private int program;
	public OpenGLShader(String vertexSource, String fragmentSource) {
		...
		RenderUtils.checkNoGLES2Error("Creating OpenGLShader");
	}
	...
	public void setVertexAttribArray(String label, int dimension, FloatBuffer buffer) {
		...
		RenderUtils.checkNoGLES2Error("setVertexAttribArray");
	}
	...
	public void useProgram() {
		...
		RenderUtils.checkNoGLES2Error("glUseProgram");
	}
	public void release() {
